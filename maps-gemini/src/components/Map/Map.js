...
export default function Map() {
    ...
    const fetchRouteFromGemini = async () => {
        ...
        `.trim();
            ...
            const { end, start, waypoints, distance_km, estimated_time_min, extraInfo, weather } = jsonData;
    ...
    return (
        <div className="flex h-screen bg-[#202020]">
            ...
            <div className="w-1/4 p-4 text-white">
                    ...
                    {(route && !editMode) && (
                        <SmallButton onClick={() => setEditMode(true)} width="w-1/4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-1">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 3.487a2.25 2.25 0 113.182 3.182l-9.193 9.193a4.5 4.5 0 01-1.591 1.06l-3.25 1.3a.75.75 0 01-.964-.964l1.3-3.25a4.5 4.5 0 011.06-1.591l9.193-9.193z" />
                                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 6.75L17.25 4.5m-2.25 2.25L4.5 17.25" />
                            </svg>
                            Edit
                        </SmallButton>
                    )}
                ...
                {route && (
                    <h3 className="font-bold">{route.origin.city} - {route.destination.city}</h3>
                )}
